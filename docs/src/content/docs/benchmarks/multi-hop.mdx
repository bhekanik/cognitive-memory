...
Cognitive Memory's latest full-run multi-hop score is 48.5% under the stated protocol, compared with Mem0 at 28.4%, FadeMem at 29.4%, and naive RAG at roughly 15%. The conv-0 rerank pilot reaches 59.3%, but it is not a full benchmark run.
