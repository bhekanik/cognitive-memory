...
```typescript
import { CognitiveMemory, ConvexAdapter } from "cognitive-memory";
...
export default defineSchema({
    memories: defineTable({
        ...
        isCold: v.optional(v.boolean()),
        coldSince: v.optional(v.number()),
...
export const search = query({
    args: {
        ...
        userId: v.string(),
        limit: v.number(),
        includeCold: v.optional(v.boolean()),
        includeStubs: v.optional(v.boolean()),
