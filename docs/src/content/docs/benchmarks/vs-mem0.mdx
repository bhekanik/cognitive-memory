...
<GroupedBarChart client:visible
  data={[
    { metric: 'Overall', cogMem: 44.8, mem0: 26.3 },
    { metric: 'Multi-hop', cogMem: 48.5, mem0: 28.4 },
    { metric: 'Single-hop', cogMem: 35.4, mem0: 28.1 },
  ]}
  xKey="metric"
  bars={[
...
The 20.5pp multi-hop gap is the most significant result. Multi-hop questions are the exact scenario where associative linking and deep recall provide value:
...
- Cognitive Memory uses the latest full-run protocol and reports token F1 by question type
