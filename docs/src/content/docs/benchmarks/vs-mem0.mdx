...
| Metric | Cognitive Memory | Mem0 | Delta |
|--------|:----------------:|:----:|:-----:|
| Overall | 42.4% | 26.3% | **+16.1pp** (+61%) |
| Multi-hop | 47.1% | 28.4% | **+18.7pp** (+66%) |
| Single-hop | 44.2% | 28.1% | **+16.1pp** (+57%) |

With deep recall + re-ranking (Run H, conv 0):

| Metric | Cognitive Memory | Mem0 | Delta |
|--------|:----------------:|:----:|:-----:|
| Overall | 47.8% | 26.3% | **+21.5pp** (+82%) |
| Multi-hop | 59.3% | 28.4% | **+30.9pp** (+109%) |
