...
Each new memory is checked against existing high-importance and core memories for contradictions or updates. See [Conflict detection](/concepts/conflict-detection/) for the full mechanism.
