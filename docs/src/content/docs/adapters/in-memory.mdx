...
The adapter is fast enough for most small workloads. If you're hitting performance limits with in-memory storage in TypeScript, use the Postgres adapter. In Python, move to a custom adapter backed by your production store.
