...
<GroupedBarChart client:visible
  data={[
    { metric: 'Overall', cogMem: 44.8, fadeMem: 27.2 },
    { metric: 'Multi-hop', cogMem: 48.5, fadeMem: 29.4 },
  ]}
  xKey="metric"
  bars={[
...
- The comparison is between FadeMem's published numbers and our latest full-run result
