...
<GroupedBarChart client:visible
  data={[
    { system: 'Cognitive Memory', overall: 44.8, multiHop: 48.5 },
...
## Where Cognitive Memory is strongest
...
<ProgressionLineChart client:visible
  data={[
    ...
    { run: 'Full', overall: 44.8, multiHop: 48.5 },
...
- E to Full: broader recall, lifecycle scoring, and aligned prompt changes produce the latest full-set result
- Full to H: LLM re-ranking on the conv-0 pilot shows the upside of larger candidate pools
